...
design_document.pdf: design_document.md pictures/architecture.pdf pictures/example_graph.pdf
	pandoc design_document.md --from=markdown+multiline_tables -o design_document.pdf --toc  -V geometry:margin=1in --latex-engine xelatex --number-sections --toc-depth=2
