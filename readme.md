...
![Example of a graph.](pictures/example_graph.pdf)
...
## Blank Canvas
![All files are closed.](ui_sketches/blank_canvas.png)


## Menu
![Menu provides list of plugins installed to create new document from.](ui_sketches/main-menu_new.png)


## New Dialog
![Allows user to create and name a new document. Provides a description of the plugin the user is using.](ui_sketches/new_file.png)


## Files Panel
![Displays list of files in project folder.](ui_sketches/Files Panel.png)


## Properties Panel
![Displays the editable properties of the selected node/edge in the editor.](ui_sketches/Properties Panel.png)


## Tools Panel
![Displays available node types and edge types a user can select.](ui_sketches/Tools Panel.png)


## Input Panel
![Allows a user to specify input and receive output. (Think: REPL)](ui_sketches/Input Panel.png)


## Test Panel
![Allows a user to specify a set of tests to run. (Think: Unit Tests)](ui_sketches/Test Panel.png)


## Debug Panel
![Allows a user to step through state transitions. (Think: Debugger)](ui_sketches/filename_debug.png)


## Full Screen
![Shows a full screen mode, optimized for displaying the graph.](ui_sketches/fullscreen.png)


## Zoomed In
![Zoom in and pan a graph to focus on certain areas for complex graphs.](ui_sketches/Zoomed In.png)


## Machine Learning Plugin
![Shows and alternative view of the editor and input panel while using the Machine Learning plugin.](ui_sketches/other_active.png)
